...
export const Sidebar = () => {
  ...
  return (<>
    <div className={`${isSidebarOpen ? "w-52 items-start" : "w-16"} group w-16 h-screen py-7 px-1 flex flex-col items-center hover:items-start hover:text-black hover:w-52 hover:px-3 gap-5 text-black bg-white dark:bg-background dark:text-white shadow-lg`}>
