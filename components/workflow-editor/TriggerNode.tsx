...
const TriggerNode = ({ id }: TriggerNodeProps) => {
  return (
    <>
      ...
      <div className="w-64 h-auto border-[1.5px] border-dashed border-gray-900 hover:border-[1px] hover:border-blue-500 hover:border-solid rounded-lg px-3 py-2 bg-white dark:bg-[#242423] shadow-xl transition-colors duration-200">
